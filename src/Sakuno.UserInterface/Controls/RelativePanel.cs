...
namespace Sakuno.UserInterface.Controls
{
    public class RelativePanel : Panel
    {
        ...
        public static void SetAlignLeftWithPanel(UIElement element, bool value) =>
            element.SetValue(AlignLeftWithPanelProperty, BooleanUtil.GetBoxed(value));
        ...
        public static void SetAlignTopWithPanel(UIElement element, bool value) =>
            element.SetValue(AlignTopWithPanelProperty, BooleanUtil.GetBoxed(value));
        ...
        public static void SetAlignRightWithPanel(UIElement element, bool value) =>
            element.SetValue(AlignRightWithPanelProperty, BooleanUtil.GetBoxed(value));
        ...
        public static void SetAlignHorizontalCenterWithPanel(UIElement element, bool value) =>
            element.SetValue(AlignHorizontalCenterWithPanelProperty, BooleanUtil.GetBoxed(value));
        ...
        public static void SetAlignVerticalCenterWithPanel(UIElement element, bool value) =>
            element.SetValue(AlignVerticalCenterWithPanelProperty, BooleanUtil.GetBoxed(value));
